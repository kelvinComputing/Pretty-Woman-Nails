...
<div class="container-menu">
  <ul>
    <li><a id="ruta-header-Home"> Home </a></li>
    <li>
      <a class="btn-service">
        Servicio <i class="fas fa-caret-down"> </i>
      </a>
      <div class="down-menu">
        <ul>
          <li><a id="ruta-header-Masaje">Masajes</a></li>
          <li>
            <a id="ruta-header-Proteccion">Protección de la Piel</a>
          </li>
          <li><a id="ruta-header-Manicura">Manicura & Pedicura</a></li>
          <li><a id="ruta-header-Cejas">Cejas</a></li>
          <li><a id="ruta-header-Pestañas">Pestañas</a></li>
        </ul>
      </div>
    </li>

    <li><a id="ruta-header-cita"> Cita </a></li>
    <a href="/InicioSesion">
      <svg
        class="icon-login1"
        fill="#000000"
    ...
    <div class="cart-service" id="service-id">
      ...
      <button class="add-cita">Confirmar</button>
    </div>
  </ul>
</div>
</div>
